...
- Timestamp: `2022-06-07 19:29`
- Build ID: `c49abca8-4a1d-461c-be2d-589c781c024f`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c49abca8-4a1d-461c-be2d-589c781c024f.git
$ cd c49abca8-4a1d-461c-be2d-589c781c024f
```
